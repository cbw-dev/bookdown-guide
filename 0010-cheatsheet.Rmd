...
* Navigate to the **<a href="https://github.com/cbw-dev/bookdown-template" target="_blank">bookdown template</a>**. Click "Use this template" and then "Create a new repository". If you don't see this button, be sure to sign in.

**2. [Set your details](#create-repo)**  

* Repo name = workshop code (e.g. INR_Mon-2510)
* Owner = bioinformaticsdotca 
* Visibility = public
* All other options = leave as is (defaults are OK)
* Save
...
For more details on this process, see the [Bookdown Crash Course](#bookdown-crash-course).
