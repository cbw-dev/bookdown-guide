...
:::: {.callout type="green" style="subtle" title="Note"}
...
:::: {.callout type="orange" style="subtle" title="Tip: Autocomplete" icon="fa-solid fa-exclamation" collapsible="true"}
...
Here's an example (recall that cd produces no output):
...
"rmdir -r [directory address]" (Terminal & Windows PowerShell) and "rmdir /s [directory address]" removes a directory recursively, meaning it deletes all the contents of the folder as we all as the folder in itself.

:::: {.callout type="red" style="important" title="There is no undo button"}

Be careful! You can not restore a directory you removed using "rmdir" (or a file removed with "rm").
