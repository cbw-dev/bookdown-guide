...
If you want to easily annotate and update your images without rebuilding the site every time., consider publishing a Google Drawing. See the [Developer's Guide](#publish-google-draw) for instructions.
