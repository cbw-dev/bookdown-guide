...
1.  Use the below widget to generate your metadata entries for the website.
    ...
    :::: {.callout type="blue" title="Metadata generator" collapsible="true" style="plain" icon="fa-solid fa-gear"}
...
4.  Open the `img/` folder and look to see if your workshop icon is present. 
...
7.  Git add, commit, and push the file. Code for use on the command line is below.
    ...
    ::: {.callout type="blue" title="Why don't I need to run a Build step like I did for my Bookdown workshop website?" collapsible="true" style="plain"}
...
8.  Go to the [actions page](https://github.com/bioinformaticsdotca/bioinformaticsdotca.github.io/actions) and confirm that your update deploys successfully. This page has built-in validation: if your data does not match the expected format, deployment will fail.
    ...
    ::: {.callout type="blue" title="Why is the homepage displaying a picture of a laptop instead of my workshop icon?" collapsible="true" style="plain"}
  
    This is a generic 404 image - the website cannot find your icon. Double-check the filename and filepath in the `workshops.json` file, and double-check that your icon is named correctly.
